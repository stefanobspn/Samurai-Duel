...
import { ASSETS, FIGHTER_STATE, FIGHTER_SCALE, FRAME_RATE, GROUND_Y } from '../constants/GameConstants.js'
...
export const MACK_SPRITESHEETS = [
  { key: ASSETS.MACK_IDLE,    path: 'img/samuraiMack/Idle.png',                       frameW: FRAME_W, frameH: FRAME_H },
  { key: ASSETS.MACK_RUN,     path: 'img/samuraiMack/Run.png',                        frameW: FRAME_W, frameH: FRAME_H },
  { key: ASSETS.MACK_JUMP,    path: 'img/samuraiMack/Jump.png',                       frameW: FRAME_W, frameH: FRAME_H },
  { key: ASSETS.MACK_FALL,    path: 'img/samuraiMack/Fall.png',                       frameW: FRAME_W, frameH: FRAME_H },
  { key: ASSETS.MACK_ATTACK1, path: 'img/samuraiMack/Attack1.png',                    frameW: FRAME_W, frameH: FRAME_H },
  { key: ASSETS.MACK_TAKEHIT, path: 'img/samuraiMack/Take Hit - white silhouette.png',frameW: FRAME_W, frameH: FRAME_H },
  { key: ASSETS.MACK_DEATH,   path: 'img/samuraiMack/Death.png',                      frameW: FRAME_W, frameH: FRAME_H },
]
